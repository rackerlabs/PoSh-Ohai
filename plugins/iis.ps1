...
function Collect-Data 
{
    ...
    $app_pool = New-Object -TypeName System.Collections.Specialized.OrderedDictionary
    foreach ($iis_pool in $iis.ApplicationPools) 
    {
        $pool = $iis_pool.name
        $app_pool[$pool] = New-Object -TypeName System.Collections.Specialized.OrderedDictionary
        ...
        # CPU settings
        $app_pool.$pool['CPU'] = New-Object -TypeName System.Collections.Specialized.OrderedDictionary
        ...
        # Process Model
        $app_pool.$pool['ProcessModel'] = New-Object -TypeName System.Collections.Specialized.OrderedDictionary
        ...
        $app_pool.$pool['RapidFailProtection'] = New-Object -TypeName System.Collections.Specialized.OrderedDictionary
        ...
        # Recycling
        $app_pool.$pool['Recycling'] = New-Object -TypeName System.Collections.Specialized.OrderedDictionary
    ...
    $app_conf = New-Object -TypeName System.Collections.Specialized.OrderedDictionary

    foreach ($site in $iis.Sites) 
    {
        $site_name = $site.name
        $app_conf[$site_name] = New-Object -TypeName System.Collections.Specialized.OrderedDictionary
        ...
        $app_conf.$site_name['Bindings'] = New-Object -TypeName System.Collections.Specialized.OrderedDictionary
        foreach ($binding in $site.bindings) 
        {
            $bindInfo = $binding.BindingInformation

            $app_conf.$site_name.Bindings[$bindInfo] = New-Object -TypeName System.Collections.Specialized.OrderedDictionary
            foreach ($bindItem in $bindInfo) 
            {
                ...
                $app_conf.$site_name.Bindings.$bindInfo['CertificateHash'] = if ($binding.CertificateHash)
                {
        ...
        $app_conf.$site_name['LogFile'] = New-Object -TypeName System.Collections.Specialized.OrderedDictionary
